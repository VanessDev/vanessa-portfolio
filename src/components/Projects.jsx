const projects = [
  {
    ...
    bullets: [
      "UX/UI (Figma), MCD/MLD, architecture MVC",
      "Création de pages React + intégration UI",
      "Back Node.js : controllers, routes, services",
      "Newsletter (CKEditor)",
      "Upload AWS S3 + intégration API YouTube",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Gestion des rôles, candidatures, disponibilités et messagerie",
    ],
    links: [],
    tag: "Projet perso",
  },
...
function ProjectCard({ p }) {
  return (
    <article className="rounded-2xl border border-black/10 bg-white p-6 hover:border-black/20 transition">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="text-right">
          ...
          <div className="mt-2 inline-flex rounded-full bg-sand px-3 py-1 text-xs text-ink/70 border border-black/5">
            {p.tag}
          </div>
        </div>
      </div>
